    ...
    *,
    ...
    lines.extend(
        [
            ...
            "  5. VERIFY, DON'T DISMISS. A claim's referenced date being past your training",
            "     cutoff is NOT grounds for 'Unverifiable'. Today's date (above) is the",
            "     authoritative now -- any date <= today has either happened or not, and you",
            "     can resolve which via web search. 'Unverifiable' is reserved for claims the",
            "     web genuinely cannot resolve (e.g. private decisions, undisclosed internal",
            "     numbers, future events with dates > today). Concrete failure mode to avoid:",
            f"     a claim like 'The White House announced X in February 2026' with today's date",
            f"     {today.isoformat()} -- February 2026 is past; do NOT return 'Unverifiable'",
            "     with reasoning like 'this is a future event' or 'I cannot confirm post-cutoff",
            "     announcements'. Run web search and let the dated reporting settle it.",
            "  6. INVOKE SEARCH BEFORE DECIDING. If you are uncertain whether a past-dated event",
            "     occurred, invoke web search FIRST and reason from what you find. Returning",
            "     'Unverifiable' without having invoked your search tool on a checkable claim is",
            "     a contract violation, not a humble admission of uncertainty.",
            "",
        ]
    )
